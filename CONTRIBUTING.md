Contributing to OneCommas Core
============================

The OneCommas Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OneCommas Core project, and is not to be
confused with overall OneCommas Network Protocol consensus changes.

Whether a pull request is merged into OneCommas Core rests with the project merge
...
Patches that change OneCommas consensus rules are considerably more involved than
...
Where a patch set proposes to change the OneCommas consensus, it must have been
...
The project leader is the release manager for each OneCommas Core release.
