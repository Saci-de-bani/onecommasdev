                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OneCommas Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OneCommas address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and onecommas: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OneCommas Core"), this);
    aboutAction->setStatusTip(tr("Show information about OneCommas Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OneCommas"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OneCommas addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OneCommas addresses"));
    ...
    openAction->setStatusTip(tr("Open a OneCommas: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the OneCommas Core help message to get a list with possible OneCommas command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OneCommas Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OneCommas network", "", count));
}
...
{
    QString strTitle = tr("OneCommas Core"); // default title
