...
/** Utility functions used by the OneCommas Qt UI.
 */
namespace GUIUtil
{
...
// Render OneCommas addresses in monospace font
...
// Parse "onecommas:" URI into recipient object, return true on successful parsing
