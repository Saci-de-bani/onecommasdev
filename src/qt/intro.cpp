...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("OneCommas Core"),
     ...
     * override -datadir in the onecommas.conf file in the default data directory
     * (to be consistent with onecommasd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
