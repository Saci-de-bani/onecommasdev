...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 53888;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // OneCommas starting difficulty is 1 / 2^12
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 90; // OneCommas: 1.5 minutes
        nTargetSpacing = 90;  // OneCommas: 6 Minutes
        nLastPOWBlock = 43200;
        nMaturity = 66;
        ...
        const char* pszTimestamp = "Aug 2 2018 Apple reached one trillion";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1533239007;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();;
        genesis.nNonce = 1605753; 
		...
		assert(hashGenesisBlock == uint256("0x00000ede0b3b0f8b14e1ec334eea485109179d592180e8c477a8a18ea99d25ff"));
	    assert(genesis.hashMerkleRoot == uint256("0x8d38b338353dc391e9ea7308c245240465053e34cebc2149196b99f054eb6c91"));
...
//		assert(genesis.hashMerkleRoot == uint256("0x57efb4ec57bf3c7424a679cc41bec99026d6e6b90a91f26cda0b8d5249559502"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
		//vSeeds.push_back(CDNSSeedData("onecommascrypto.com", "test01.onecommascrypto.com"));
		//vSeeds.push_back(CDNSSeedData("onecommascrypto.com", "test02.onecommascrypto.com"));
		//vSeeds.push_back(CDNSSeedData("onecommascrypto.com", "test03.onecommascrypto.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet onecommas addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);  // Testnet onecommas script addresses start with '5' or '6'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet onecommas BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet onecommas BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet onecommas BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // OneCommas: 1 day
        nTargetSpacing = 1 * 60;        // OneCommas: 1 minutes
