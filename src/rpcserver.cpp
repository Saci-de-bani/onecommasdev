...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop One Commas server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "One Commas server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* One Commas features */
        {"onecommas", "masternode", &masternode, true, true, false},
        {"onecommas", "listmasternodes", &listmasternodes, true, true, false},
        {"onecommas", "getmasternodecount", &getmasternodecount, true, true, false},
        {"onecommas", "masternodeconnect", &masternodeconnect, true, true, false},
        {"onecommas", "masternodecurrent", &masternodecurrent, true, true, false},
        {"onecommas", "masternodedebug", &masternodedebug, true, true, false},
        {"onecommas", "startmasternode", &startmasternode, true, true, false},
        {"onecommas", "createmasternodekey", &createmasternodekey, true, true, false},
        {"onecommas", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"onecommas", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"onecommas", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"onecommas", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"onecommas", "getmasternodescores", &getmasternodescores, true, true, false},
        {"onecommas", "mnbudget", &mnbudget, true, true, false},
        {"onecommas", "preparebudget", &preparebudget, true, true, false},
        {"onecommas", "submitbudget", &submitbudget, true, true, false},
        {"onecommas", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"onecommas", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"onecommas", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"onecommas", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"onecommas", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"onecommas", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"onecommas", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"onecommas", "checkbudgets", &checkbudgets, true, true, false},
        {"onecommas", "mnsync", &mnsync, true, true, false},
        {"onecommas", "spork", &spork, true, true, false},
        {"onecommas", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"onecommas", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use onecommasd, or the -server option to onecommas-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"One Commas Alert\" admin@foo.com\n"),
...
{
    return "> onecommas-cli " + methodname + " " + args + "\n";
}
