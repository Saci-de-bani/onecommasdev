/* src/config/onecommas-config.h.  Generated from onecommas-config.h.in by configure.  */
/* src/config/onecommas-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.draftdaily.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "OneCommas Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "OneCommas Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "onecommas"
