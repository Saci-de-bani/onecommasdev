...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OneCommas Core onecommas-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  onecommas-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded onecommas transaction") + "\n" +
                               "  onecommas-tx [options] -create [commands]   " + _("Create hex-encoded onecommas transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded onecommas transaction
