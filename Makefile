...
pkgdatadir = $(datadir)/onecommas
pkgincludedir = $(includedir)/onecommas
pkglibdir = $(libdir)/onecommas
pkglibexecdir = $(libexecdir)/onecommas
...
CONFIG_HEADER = $(top_builddir)/src/config/onecommas-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/onecommas-config.h.in \
...
ACLOCAL = ${SHELL} /home/fire/coding/OneCommas/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/fire/coding/OneCommas/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/fire/coding/OneCommas/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/fire/coding/OneCommas/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = onecommas-cli
BITCOIN_DAEMON_NAME = onecommasd
BITCOIN_GUI_NAME = onecommas-qt
BITCOIN_TX_NAME = onecommas-tx
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/fire/coding/OneCommas/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = onecommas
PACKAGE_BUGREPORT = www.draftdaily.com
PACKAGE_NAME = OneCommas Core
PACKAGE_STRING = OneCommas Core 1.0.0
PACKAGE_TARNAME = onecommas
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/fire/coding/OneCommas
abs_srcdir = /home/fire/coding/OneCommas
abs_top_builddir = /home/fire/coding/OneCommas
abs_top_srcdir = /home/fire/coding/OneCommas
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/fire/coding/OneCommas/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/onecommasd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/onecommas-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/onecommas-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = OneCommas-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_onecommas_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_onecommas_coverage.info test_onecommas.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/OneCommas-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/onecommas-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/onecommas-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/onecommas-config.h
$(top_srcdir)/src/config/onecommas-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/onecommas-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/OneCommas-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/OneCommas-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/OneCommas-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_onecommas.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_onecommas -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_onecommas_filtered.info: test_onecommas.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_onecommas_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_onecommas_coverage.info: baseline_filtered_combined.info test_onecommas_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_onecommas_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_onecommas_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_onecommas_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_onecommas.coverage/.dirstamp:  test_onecommas_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_onecommas.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local:
	rm -rf test_onecommas.coverage/ total.coverage/ $(OSX_APP)
