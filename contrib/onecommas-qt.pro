...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/onecommas-cli.cpp \
           src/onecommas-tx.cpp \
           src/onecommas.cpp \
           src/db.cpp \
           ...
           src/qt/onecommas.cpp \
           src/qt/onecommasstrings.cpp \
...
RESOURCES += src/qt/onecommas.qrc src/qt/onecommas_locale.qrc

TRANSLATIONS += src/qt/locale/onecommas_bg.ts \
                src/qt/locale/onecommas_de.ts \
                src/qt/locale/onecommas_en.ts \
                src/qt/locale/onecommas_es.ts \
                src/qt/locale/onecommas_fi.ts \
                src/qt/locale/onecommas_fr.ts \
                src/qt/locale/onecommas_it.ts \
                src/qt/locale/onecommas_ja.ts \
                src/qt/locale/onecommas_pl.ts \
                src/qt/locale/onecommas_pt.ts \
                src/qt/locale/onecommas_ru.ts \
                src/qt/locale/onecommas_sk.ts \
                src/qt/locale/onecommas_sv.ts \
                src/qt/locale/onecommas_vi.ts \
                src/qt/locale/onecommas_zh_CN.ts \
                src/qt/locale/onecommas_zh_TW.ts
