...
In order to support loading of multiple wallets in onecommas-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is onecommas.cpp.
...
Changes to onecommas.cpp
----------------------
onecommas.cpp is the entry point into onecommas-qt, and as such, will require some minor modifications to provide hooks for
