...
This mechanism has been integrated into Bitcore-Node-OneCommas which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/OneCommas/insight-api-onecommas#web-socket-api](https://github.com/OneCommas/insight-api-onecommas#web-socket-api) 
* API: [https://github.com/OneCommas/insight-api-onecommas#swifttx-transactions](https://github.com/OneCommas/insight-api-onecommas#swifttx-transactions) 
...
By default, the OneCommas Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the OneCommas Core daemon:
